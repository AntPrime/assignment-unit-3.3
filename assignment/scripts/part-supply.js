...
console.log(`Removed the last value`, removedItem);
console.log(`The suppleChanges values are now`, supplyChanges);
...
console.log(`Added new parts to end of SupplyChanges`, supplyChanges);
